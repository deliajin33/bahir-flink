    ...
    public void invoke(IN input, Context context) throws Exception {
        ...
        switch (redisCommand) {
            ...
            case HSET:
                ...
                break;
            case HSETNX:
                this.redisCommandsContainer.hsetNx(key, optAdditionalKey.orElse(this.additionalKey), value, optAdditionalTTL.orElse(this.additionalTTL));
                break;
            case HINCRBY:
            ...
            case DESCRBY_EX:
                ...
                break;
            case HDEL:
                this.redisCommandsContainer.hdel(key, optAdditionalKey.orElse(this.additionalKey).split(";"));
                break;
            default:
